    ...
    >
      ...
      <g fill={fill}>
        ...
        <path
          ...
          strokeWidth={strokewidth}
        />
        <path d="M7 9.5H5V11H7V9.5Z" fill={fill} stroke="none" />
        <path d="M9 11H7V12.5H9V11Z" fill={fill} stroke="none" />
        <path d="M7 12.5H5V14H7V12.5Z" fill={fill} stroke="none" />
        <path d="M9 14H7V15.5H9V14Z" fill={fill} stroke="none" />
      </g>
    </svg>
  );
}
