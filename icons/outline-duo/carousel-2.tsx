...
function Carousel2({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M6.25 15.25H11.75C12.302 15.25 12.75 14.802 12.75 14.25V3.75C12.75 3.198 12.302 2.75 11.75 2.75H6.25C5.698 2.75 5.25 3.198 5.25 3.75V14.25C5.25 14.802 5.698 15.25 6.25 15.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
