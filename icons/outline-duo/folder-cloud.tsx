  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M13.75 6.75C14.855 6.75 15.75 7.645 15.75 8.75C15.75 9.11619 15.8424 9.67487 15.5887 9.61858C15.2382 9.54083 14.8739 9.5 14.5 9.5C12.7867 9.5 11.2976 10.363 10.4033 11.6553C8.80504 12.1098 7.59041 13.531 7.48438 15.25H4.25C3.145 15.25 2.25 14.355 2.25 13.25V8.75C2.25 7.645 3.145 6.75 4.25 6.75H13.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
