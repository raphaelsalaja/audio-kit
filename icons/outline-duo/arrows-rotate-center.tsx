...
function ArrowsRotateCenter({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M9 16.25C13.0041 16.25 16.25 13.004 16.25 9C16.25 4.996 13.0041 1.75 9 1.75C4.9959 1.75 1.75 4.996 1.75 9C1.75 13.004 4.9959 16.25 9 16.25ZM9 11C10.1046 11 11 10.105 11 9C11 7.895 10.1046 7 9 7C7.8954 7 7 7.895 7 9C7 10.105 7.8954 11 9 11Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
        />
        <path
          d="M16.2472 8.79581C16.1391 4.88621 12.9357 1.75 8.99999 1.75C5.98659 1.75 3.40309 3.58849 2.30899 6.20419"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
