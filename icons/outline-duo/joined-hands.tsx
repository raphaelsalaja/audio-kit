...
function JoinedHands({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m7.625,7.75c-.1732,0-.3374.0356-.4901.094l.0004-.002,1.1049-4.4219c.1645-.6582-.2061-1.332-.85-1.5457-.6262-.2078-1.3086.0876-1.5857.6865l-1.8696,4.0393c-.1219.2632-.185.55-.185.8401v5.5596l-2,2,5,1.25,1.6642-1.6643c.3751-.375.5858-.8838.5858-1.4141v-4.0466c0-.7593-.6156-1.375-1.375-1.375Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
        <path
          d="m10.375,7.75c.1732,0,.3374.0356.4901.094l-.0004-.002-1.1049-4.4219c-.1645-.6582.2061-1.332.85-1.5457.6262-.2078,1.3086.0876,1.5857.6865l1.8696,4.0393c.1219.2632.185.55.185.8401v5.5596s2,2,2,2l-5,1.25-1.6642-1.6643c-.3751-.375-.5858-.8838-.5858-1.4141v-4.0466c0-.7593.6156-1.375,1.375-1.375Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
