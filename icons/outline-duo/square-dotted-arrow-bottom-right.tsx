...
function SquareDottedArrowBottomRight({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M4.5 2.5C3.39543 2.5 2.5 3.39543 2.5 4.5V13.5C2.5 14.6046 3.39543 15.5 4.5 15.5H9.25V9.25H15.5V4.5C15.5 3.39543 14.6046 2.5 13.5 2.5H4.5Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
