...
function UsersShield({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M12 7C13.2427 7 14.25 5.99264 14.25 4.75C14.25 3.50736 13.2427 2.5 12 2.5C11.9029 2.5 10.9372 2.54745 11.069 2.82569C11.3454 3.40912 11.5 4.06151 11.5 4.75C11.5 5.43745 11.3458 6.08889 11.0702 6.67165C10.9429 6.94089 11.8814 7 12 7Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
