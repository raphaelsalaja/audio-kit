...
function Heart2Sparkle({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m15.2,9.222l-.4765.5721c-.3674-.2336-.8888-.2941-1.224-.2941-.6359,0-1.5627.3345-1.8965,1.3285l-.1849.5546-.5514.1839c-.8149.2716-1.3677,1.0347-1.3677,1.897,0,.4604.1575.8924.4284,1.2365l-.2074.2155c-.393.409-1.048.409-1.441,0l-5.48-5.694c-1.452-1.528-1.389-3.944.139-5.395,1.528-1.452,3.944-1.389,5.395.139.27.284.495.609.666.962,1.074-2.212,4.002-2.92,6.007-1.162.535.469.929,1.101,1.11,1.79.363,1.383-.034,2.738-.916,3.666Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity=".3"
          strokeWidth="0"
        ...
        />
        <path
          d="m12.25,7c.4142,0,.75-.3358.75-.75s-.3358-.75-.75-.75-.75.3358-.75.75.3358.75.75.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
        ...
        <path
          ...
          strokeWidth="0"
        />
        <circle cx="12.25" cy="6.25" fill={fill} r=".75" strokeWidth="0" />
      </g>
    </svg>
  );
}
