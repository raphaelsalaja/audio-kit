...
function OctagonInfo({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M10.968 2.25H7.03297C6.50297 2.25 5.99398 2.461 5.61898 2.836L2.83698 5.61798C2.46198 5.99298 2.25098 6.50198 2.25098 7.03198V10.967C2.25098 11.497 2.46198 12.006 2.83698 12.381L5.61898 15.163C5.99398 15.538 6.50297 15.749 7.03297 15.749H10.968C11.498 15.749 12.007 15.538 12.382 15.163L15.164 12.381C15.539 12.006 15.75 11.497 15.75 10.967V7.03198C15.75 6.50198 15.539 5.99298 15.164 5.61798L12.382 2.836C12.007 2.461 11.498 2.25 10.968 2.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
