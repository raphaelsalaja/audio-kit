  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M9 16.25C10.1046 16.25 11 15.3546 11 14.25C11 13.1454 10.1046 12.25 9 12.25C7.89543 12.25 7 13.1454 7 14.25C7 15.3546 7.89543 16.25 9 16.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
        ...
        />
        <path
          d="M4.75 5.75V6.75C4.75 7.855 5.645 8.75 6.75 8.75H9H11.25C12.355 8.75 13.25 7.855 13.25 6.75V5.75"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
