...
function WalletKey({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.75 6.75H4C2.895 6.75 2.25 5.855 2.25 4.75V10.0941C2.5723 10.0157 2.904 10 3.25 10C4.7266 10 6.0767 10.7832 6.8403 12H9.25C10.4907 12 11.5 13.0093 11.5 14.25C11.5 14.5135 11.4527 14.7655 11.3681 15C11.3372 15.0858 11.4745 15.25 11.5843 15.25H14.75C15.302 15.25 15.75 14.802 15.75 14.25V7.75C15.75 7.198 15.302 6.75 14.75 6.75Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
