...
function MessageSparkle({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M3.75 2.25H14.25C15.355 2.25 16.25 3.146 16.25 4.25V8.81759C16.136 8.94137 15.8041 9.27721 15.6275 9.00998C15.2185 8.39084 14.5191 8 13.7501 8C12.781 8 11.9216 8.62132 11.6156 9.53849L11.2215 10.7211L10.0367 11.1157C9.12014 11.4225 8.50018 12.2806 8.50018 13.25C8.50018 13.5682 8.56698 13.8744 8.68914 14.1531L5.75 16.25V13.25H3.75C2.645 13.25 1.75 12.354 1.75 11.25V4.25C1.75 3.146 2.645 2.25 3.75 2.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
