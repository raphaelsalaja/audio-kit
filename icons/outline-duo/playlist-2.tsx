  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M10.715 8.482L8.407 7.09701C8.004 6.85501 7.491 7.14501 7.491 7.61501V10.386C7.491 10.856 8.004 11.146 8.407 10.904L10.715 9.519C11.106 9.284 11.106 8.717 10.715 8.482Z"
          fill={fill}
          stroke="none"
        />
        <path
