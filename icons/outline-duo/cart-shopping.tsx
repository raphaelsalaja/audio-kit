...
function CartShopping({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M4.12863 4.75H14.3791C15.0641 4.75 15.5463 5.4231 15.326 6.07166L13.9667 9.59321C13.829 9.99871 13.4482 10.2715 13.0199 10.2715H5.00096L4.12863 4.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
