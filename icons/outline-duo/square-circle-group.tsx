...
function SquareCircleGroup({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M9.75 5.25H5.25V9.75H9.75V5.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
        <path
          d="M8.127 9.75C8.052 9.988 8 10.237 8 10.5C8 11.881 9.119 13 10.5 13C11.881 13 13 11.881 13 10.5C13 9.119 11.881 8 10.5 8C10.237 8 9.988 8.052 9.75 8.127"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
