  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="m7.75,11.5v-2.0066l1.2064-1.2537.0007.001c.4556-.48.6614-1.1816.4735-1.8965-.0936-.3564-.2979-.6826-.5742-.9255-1.0371-.9094-2.5513-.5437-3.1069.6006-.0886-.1829-.2043-.3506-.3443-.4978-.7506-.7905-2.0005-.8228-2.7905-.0723-.7906.7507-.8228,2.0007-.0721,2.7905l1.2074,1.2544v2.0059h4Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
