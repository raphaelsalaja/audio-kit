...
function InvoiceDollar({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.75 3.75V16.25L12 14.75L9 16.25L6 14.75L3.25 16.25V3.75C3.25 2.645 4.145 1.75 5.25 1.75H12.75C13.855 1.75 14.75 2.645 14.75 3.75Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
