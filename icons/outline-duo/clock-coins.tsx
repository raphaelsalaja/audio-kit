...
function ClockCoins({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.25 10.25H9.75C9.198 10.25 8.75 10.698 8.75 11.25V12.25C8.75 12.802 9.198 13.25 9.75 13.25H14.25C14.802 13.25 15.25 12.802 15.25 12.25V11.25C15.25 10.698 14.802 10.25 14.25 10.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
        <path
          d="M15.25 7.25H10.75C10.198 7.25 9.75 7.698 9.75 8.25V9.25C9.75 9.802 10.198 10.25 10.75 10.25H15.25C15.802 10.25 16.25 9.802 16.25 9.25V8.25C16.25 7.698 15.802 7.25 15.25 7.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
        <path
          d="M15.25 13.25H10.75C10.198 13.25 9.75 13.698 9.75 14.25V15.25C9.75 15.802 10.198 16.25 10.75 16.25H15.25C15.802 16.25 16.25 15.802 16.25 15.25V14.25C16.25 13.698 15.802 13.25 15.25 13.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
