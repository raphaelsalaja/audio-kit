...
function ScaleFromBottomRight2({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M11.25 15.25H13.25C14.3546 15.25 15.25 14.3546 15.25 13.25V11.25C15.25 10.1454 14.3546 9.25 13.25 9.25H11.25C10.1454 9.25 9.25 10.1454 9.25 11.25V13.25C9.25 14.3546 10.1454 15.25 11.25 15.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
