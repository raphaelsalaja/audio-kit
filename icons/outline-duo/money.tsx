...
function Money({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M5 3.75H13C13 5.545 14.455 7 16.25 7V11C14.455 11 13 12.455 13 14.25H5C5 12.455 3.545 11 1.75 11V7C3.545 7 5 5.545 5 3.75ZM11 9C11 10.105 10.105 11 9 11C7.895 11 7 10.105 7 9C7 7.895 7.895 7 9 7C10.105 7 11 7.895 11 9Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
