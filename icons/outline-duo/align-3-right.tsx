  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M15.25 13.75V12.25C15.25 11.4216 14.5784 10.75 13.75 10.75H10.25C9.42157 10.75 8.75 11.4216 8.75 12.25V13.75C8.75 14.5784 9.42157 15.25 10.25 15.25H13.75C14.5784 15.25 15.25 14.5784 15.25 13.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
