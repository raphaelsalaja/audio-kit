...
function ChessKnight({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m7.25,1v2l-3.8962,2.252c-.4521.2612-.6271.8264-.4016,1.2976l.3501.7312c.228.4761.7798.6738,1.2762.4941,2.2571-.8164,2.7203.3394,4.2297.0237l.0012-.0007,1.7211-.7754s.1566,1.9768-3.3998,2.9932c-.8268.7715-1.5521,1.5894-1.3807,3.2344h6.5C15.9375,7.5,13.5312,1.3125,7.25,1Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
        ...
        <path
          ...
          strokeWidth={strokewidth}
        />
        <circle cx="8.75" cy="4.75" fill={fill} r=".75" strokeWidth="0" />
      </g>
    </svg>
  );
}
