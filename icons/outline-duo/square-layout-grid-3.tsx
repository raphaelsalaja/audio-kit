...
function SquareLayoutGrid3({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M2.75 10.75H9V15.25H4.75C3.64543 15.25 2.75 14.3546 2.75 13.25V10.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
        <path
          d="M15.25 7.25L9 7.25L9 2.75L13.25 2.75C14.3546 2.75 15.25 3.64543 15.25 4.75L15.25 7.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
