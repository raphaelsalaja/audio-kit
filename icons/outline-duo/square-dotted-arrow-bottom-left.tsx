...
function SquareDottedArrowBottomLeft({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M15.5 4.5C15.5 3.39543 14.6046 2.5 13.5 2.5L4.5 2.5C3.39543 2.5 2.5 3.39543 2.5 4.5L2.5 9.25L8.75 9.25L8.75 15.5L13.5 15.5C14.6046 15.5 15.5 14.6046 15.5 13.5L15.5 4.5Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
