...
function Investment3({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.25 1.75H3.75C2.922 1.75 2.25 2.4219 2.25 3.25V8.75C2.25 9.5781 2.922 10.25 3.75 10.25H14.25C15.078 10.25 15.75 9.5781 15.75 8.75V3.25C15.75 2.4219 15.078 1.75 14.25 1.75ZM9 7.75C8.034 7.75 7.25 6.9661 7.25 6C7.25 5.0339 8.034 4.25 9 4.25C9.966 4.25 10.75 5.0339 10.75 6C10.75 6.9661 9.966 7.75 9 7.75Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
