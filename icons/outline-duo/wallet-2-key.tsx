...
function Wallet2Key({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M13 8.25H15.75V6.5C15.75 5.395 14.855 4.5 13.75 4.5H4.25C3.145 4.5 2.25 5.395 2.25 6.5V10.0505C2.416 10.0307 2.5788 10 2.75 10C4.2256 10 5.57621 10.7832 6.33981 12H8.75C9.9902 12 11 13.0093 11 14.25C11 14.4975 10.9583 14.7348 10.8831 14.9571C10.849 15.058 10.9294 15.2177 11.0647 15.25H13.75C14.855 15.25 15.75 14.355 15.75 13.25V11.75H13C12.034 11.75 11.25 10.9661 11.25 10C11.25 9.033 12.034 8.25 13 8.25Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
        ...
        />
        <path
          d="M11.571 15.25H13.7499C14.8549 15.25 15.7499 14.355 15.7499 13.25V11.75"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
