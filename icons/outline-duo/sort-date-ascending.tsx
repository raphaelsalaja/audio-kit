  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M8.25 15.25H4.25C3.145 15.25 2.25 14.355 2.25 13.25V4.75C2.25 3.645 3.145 2.75 4.25 2.75H13.75C14.855 2.75 15.75 3.645 15.75 4.75V9.25"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
        ...
        />
        <path
          d="M10.75 13.25L13.25 10.75L15.75 13.25"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
