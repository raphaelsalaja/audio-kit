...
function PositionBottom({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m3.25,15.25h11.5c.2761,0,.5-.2239.5-.5v-2.5c0-.2761-.2239-.5-.5-.5H3.25c-.2761,0-.5.2239-.5.5v2.5c0,.2761.2239.5.5.5Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
        <path
          d="m3.75,15.25h10.5c.5523,0,1-.4477,1-1v-1.5c0-.5523-.4477-1-1-1H3.75c-.5523,0-1,.4477-1,1v1.5c0,.5523.4477,1,1,1Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
