...
function GridObjSnapToBottomLeft({
  fill = "currentColor",
  secondaryfill,
  strokewidth = 1,
  width = "1em",
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M2.25 11.75L2.25 14.75C2.25 15.3023 2.69772 15.75 3.25 15.75H6.25C6.80228 15.75 7.25 15.3023 7.25 14.75V11.75C7.25 11.1977 6.80228 10.75 6.25 10.75H3.25C2.69772 10.75 2.25 11.1977 2.25 11.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
