...
function ShieldHalved({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M9 1.80075C8.897 1.80071 8.79412 1.81646 8.695 1.848L3.445 3.528C3.031 3.66 2.75 4.045 2.75 4.48V11C2.75 14.03 7.434 15.748 8.692 16.155C8.7935 16.188 8.89675 16.2045 9 16.2045V1.80075Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
