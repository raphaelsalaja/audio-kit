...
function FileCheck({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M10.3359 1.75C10.48 1.75 10.6212 1.78131 10.75 1.83984V5.25C10.75 5.802 11.198 6.25 11.75 6.25H15.1602C15.2188 6.37884 15.25 6.51984 15.25 6.66406V8.17862C15.25 8.34309 15.2457 8.64106 15.0845 8.60859C14.7338 8.53795 14.3713 8.5 14 8.5C10.9654 8.5 8.5 10.9661 8.5 14C8.5 14.6988 8.63172 15.367 8.87036 15.9823C8.87883 16.0041 8.86914 16.031 8.84958 16.0592C8.74058 16.2165 8.52719 16.25 8.33583 16.25H4.75C3.645 16.25 2.75 15.355 2.75 14.25V3.75C2.75 2.645 3.645 1.75 4.75 1.75H10.3359Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
