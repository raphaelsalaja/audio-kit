...
function CreditCardLock({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14 7.25H1.75V12.25C1.75 13.355 2.6454 14.25 3.75 14.25H9V13.75C9 12.5959 9.6014 11.583 10.5078 11.0059C10.6282 9.13331 12.1286 7.6499 14 7.5242V7.25Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
