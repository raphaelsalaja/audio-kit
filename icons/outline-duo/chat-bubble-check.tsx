...
function ChatBubbleCheck({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M4.25 2.75H13.75C14.855 2.75 15.75 3.645 15.75 4.75V7.39159C15.75 7.53959 15.6857 7.76173 15.5437 7.72018C15.0538 7.57687 14.5358 7.5 14 7.5C10.9654 7.5 8.5 9.96609 8.5 13C8.5 13.0838 8.50188 13.1671 8.5056 13.25H6L2.25 16.25V4.75C2.25 3.645 3.145 2.75 4.25 2.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
