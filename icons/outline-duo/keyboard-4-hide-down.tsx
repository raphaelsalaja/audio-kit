...
function Keyboard4HideDown({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.25 3.75H3.75C2.64543 3.75 1.75 4.64543 1.75 5.75V10.25C1.75 11.3546 2.64543 12.25 3.75 12.25H14.25C15.3546 12.25 16.25 11.3546 16.25 10.25V5.75C16.25 4.64543 15.3546 3.75 14.25 3.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
