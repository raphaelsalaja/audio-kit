...
function SidebarRight4({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M16.25 13.25C16.25 14.3546 15.3546 15.25 14.25 15.25L9.75 15.25L9.75 2.75L14.25 2.75C15.3546 2.75 16.25 3.64543 16.25 4.75L16.25 13.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
