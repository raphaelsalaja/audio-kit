...
function Hand3({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m14.75,6.75c-1.1046,0-2,.8955-2,2V3.75c0-.6904-.5596-1.25-1.25-1.25s-1.25.5596-1.25,1.25v-1.25c0-.6904-.5596-1.25-1.25-1.25s-1.25.5596-1.25,1.25v1.25c0-.6904-.5596-1.25-1.25-1.25s-1.25.5596-1.25,1.25v1.5c0-.6904-.5596-1.25-1.25-1.25s-1.25.5596-1.25,1.25v4.9868h-.001v.4976c0,.0066.001.0127.001.0193v1.2825h.1447c.5951,2.687,2.9881,4.6982,5.8543,4.6982h1.001c2.9595,0,5.4127-2.1448,5.9045-4.9636h.0955v-5.0208h-1Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
