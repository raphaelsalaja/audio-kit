...
function BrainNodes2({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M11.25 2.25C10.007 2.25 9 3.257 9 4.5C9 3.257 7.993 2.25 6.75 2.25C5.507 2.25 4.5 3.257 4.5 4.5C4.5 4.593 4.516 4.682 4.527 4.772C3.252 4.886 2.25 5.945 2.25 7.25C2.25 8.27 2.863 9.145 3.739 9.533C3.15 9.881 2.75 10.516 2.75 11.25C2.75 12.278 3.529 13.115 4.527 13.228C4.516 13.318 4.5 13.407 4.5 13.5C4.5 14.743 5.507 15.75 6.75 15.75C7.993 15.75 9 14.743 9 13.5C9 14.743 10.007 15.75 11.25 15.75C12.493 15.75 13.5 14.743 13.5 13.5C13.5 13.407 13.484 13.318 13.473 13.228C14.471 13.115 15.25 12.278 15.25 11.25C15.25 10.516 14.85 9.881 14.261 9.533C15.137 9.145 15.75 8.27 15.75 7.25C15.75 5.945 14.748 4.886 13.473 4.772C13.484 4.682 13.5 4.593 13.5 4.5C13.5 3.257 12.493 2.25 11.25 2.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
