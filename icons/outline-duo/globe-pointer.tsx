  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M10.1116 16.07C9.5746 16.197 9.076 16.25 8.5 16.25C4.496 16.25 1.25 13.004 1.25 9C1.25 4.996 4.496 1.75 8.5 1.75C12.504 1.75 15.75 4.996 15.75 9C15.75 9.351 15.7525 9.4795 15.7045 9.8175L15.4741 9.96091L11.898 8.655L11.891 8.65201C9.88799 7.92801 7.90899 9.866 8.65399 11.901L8.655 11.903L10.1264 15.9313L10.1116 16.07Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
