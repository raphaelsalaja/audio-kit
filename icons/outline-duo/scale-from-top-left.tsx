...
function ScaleFromTopLeft({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M8.25 2.75L8.25 7.25C8.25 7.80228 7.80228 8.25 7.25 8.25L2.75 8.25L2.75 4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L8.25 2.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
        <path
          d="M2.75 8.25H7.25C7.802 8.25 8.25 7.802 8.25 7.25V2.75"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
