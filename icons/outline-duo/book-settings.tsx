...
function BookSettings({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M4.5 12.75H15.25V1.75H4.75C3.645 1.75 2.75 2.645 2.75 3.75V14.5C2.75 13.533 3.534 12.75 4.5 12.75ZM11 7.25C11 8.35457 10.1046 9.25 9 9.25C7.89543 9.25 7 8.35457 7 7.25C7 6.14543 7.89543 5.25 9 5.25C10.1046 5.25 11 6.14543 11 7.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
        ...
        />
        <path
          d="M11.2981 4.9519L10.591 5.659"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M11.2981 9.5481L10.591 8.841"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
