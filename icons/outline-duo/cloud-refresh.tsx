...
function CloudRefresh({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M13.464 6.89111C13.278 4.57711 11.362 2.75 9 2.75C6.515 2.75 4.5 4.7651 4.5 7.25C4.5 7.6001 4.549 7.93598 4.624 8.26288C3.027 8.32998 1.75 9.6369 1.75 11.25C1.75 12.48 2.49 13.5371 3.549 14H4.0157C4.2708 11.4805 6.4144 9.5 9 9.5C9.4019 9.5 9.7974 9.54739 10.1802 9.63959C10.586 9.24409 11.1402 9 11.75 9C12.9907 9 14 10.0093 14 11.25L14.0235 13.5529C14.0235 13.5529 14.2165 13.8284 14.3309 13.7642C15.4748 13.1227 16.25 11.904 16.25 10.4999C16.25 8.76378 15.065 7.31791 13.464 6.89111Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
