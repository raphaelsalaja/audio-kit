...
function PlaneSlash({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M6.88507 14.2969L10.75 10.432V11.215C10.75 11.738 10.709 12.259 10.628 12.775L10.156 15.762C10.066 16.331 9.57602 16.75 9.00002 16.75C8.42402 16.75 7.93402 16.331 7.84402 15.762L6.88507 14.2969Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
        <path
          d="M10.75 7.24997V3.5C10.75 2.534 9.966 1.75 9 1.75C8.034 1.75 7.25 2.534 7.25 3.5V10.75L10.75 7.24997Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
        ...
        />
        <path
          d="M10.75 10.396L16.75 11.25V9.67599C16.75 9.26799 16.502 8.9 16.123 8.748L14.253 7.98911"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M7.84401 15.762L7.12971 14.0513L4.25601 16.925C4.34301 16.975 4.44101 17.008 4.55001 16.997L8.44501 16.59C8.13701 16.42 7.90201 16.13 7.84401 15.762Z"
          fill={fill}
          stroke="none"
        />
      </g>
