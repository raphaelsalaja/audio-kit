  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M14 17.25C15.795 17.25 17.25 15.795 17.25 14C17.25 12.205 15.795 10.75 14 10.75C12.205 10.75 10.75 12.205 10.75 14C10.75 15.795 12.205 17.25 14 17.25Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
