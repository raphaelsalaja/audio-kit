  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M14 16.25C15.243 16.25 16.25 15.24 16.25 14C16.25 12.76 15.243 11.75 14 11.75C12.757 11.75 11.75 12.76 11.75 14C11.75 15.24 12.757 16.25 14 16.25Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M15.5901 15.59L17.2501 17.25"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M16.25 9.25745V4.75C16.25 3.65 15.355 2.75 14.25 2.75H3.75C2.645 2.75 1.75 3.65 1.75 4.75V13.25C1.75 14.35 2.645 15.25 3.75 15.25H8.90079"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
