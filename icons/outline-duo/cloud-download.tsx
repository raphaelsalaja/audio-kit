...
function CloudDownload({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M13.464 6.89099C13.278 4.57699 11.362 2.75 9 2.75C6.515 2.75 4.5 4.765 4.5 7.25C4.5 7.6 4.549 7.936 4.624 8.263C3.027 8.33 1.75 9.637 1.75 11.25C1.75 12.907 3.093 14.25 4.75 14.25H12.5C14.571 14.25 16.25 12.571 16.25 10.5C16.25 8.764 15.065 7.31799 13.464 6.89099Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
        <path
          d="M11.25 12L9 14.25L6.75 12"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
