...
function WandSparkle({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M12.6414 7.60865L10.3913 5.35864L3.04247 12.7075C2.65194 13.098 2.65194 13.7312 3.04247 14.1217L3.87827 14.9575C4.26879 15.348 4.90196 15.348 5.29248 14.9575L12.6414 7.60865Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
