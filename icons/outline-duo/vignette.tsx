...
function Vignette({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.25 2.75C15.355 2.75 16.25 3.645 16.25 4.75V13.25C16.25 14.355 15.355 15.25 14.25 15.25H3.75C2.645 15.25 1.75 14.355 1.75 13.25V4.75C1.75 3.645 2.645 2.75 3.75 2.75H14.25ZM9 5.75C6.6531 5.75 4.75 7.2051 4.75 9C4.75 10.7949 6.6531 12.25 9 12.25C11.3469 12.25 13.25 10.7949 13.25 9C13.25 7.2051 11.3469 5.75 9 5.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
