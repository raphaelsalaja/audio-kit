...
function BracketsCurlySparkle({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m11.75,15.25h1c1.105,0,2-.895,2-2v-2.625c0-.897.728-1.625,1.625-1.625-.897,0-1.625-.728-1.625-1.625v-2.625c0-1.105-.895-2-2-2h-7.5c-1.105,0-2,.895-2,2v2.625c0,.897-.728,1.625-1.625,1.625.897,0,1.625.728,1.625,1.625v2.625c0,1.105.895,2,2,2h6.5Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
