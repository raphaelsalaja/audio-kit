...
function Obj3dFront({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m2.665,7.9502l5.8869-3.0698c.2903-.1514.6364-.1511.9264.0009l5.8587,3.069c.534.281.534,1.046,0,1.327l-5.87,3.091c-.292.154-.64.154-.932,0l-5.87-3.091c-.534-.281-.534-1.046,0-1.327Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
