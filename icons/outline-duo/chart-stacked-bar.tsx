...
function ChartStackedBar({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M13.25 12.25H15.75V14.25C15.75 14.802 15.302 15.25 14.75 15.25H14.25C13.698 15.25 13.25 14.802 13.25 14.25V12.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
        <path
          d="M2.25 11.25H4.75V14.25C4.75 14.802 4.302 15.25 3.75 15.25H3.25C2.698 15.25 2.25 14.802 2.25 14.25V11.25Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
        <path
          d="M7.75 9.75H10.25V14.25C10.25 14.802 9.802 15.25 9.25 15.25H8.75C8.198 15.25 7.75 14.802 7.75 14.25V9.75Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
