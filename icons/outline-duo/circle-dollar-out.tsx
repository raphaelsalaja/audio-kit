...
function CircleDollarOut({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m10,14.75c0-1.2407,1.0093-2.25,2.25-2.25h.2744c-.0092-.0833-.0244-.165-.0244-.25,0-.6011.2339-1.166.6592-1.5908.4248-.4253.9897-.6592,1.5908-.6592.3897,0,.7612.1031,1.0909.2903.0904.0513.4091-.7891.4091-1.2903,0-4.0039-3.246-7.25-7.25-7.25S1.75,4.9961,1.75,9s3.246,7.25,7.25,7.25c.5013,0,1.3456-.3135,1.295-.4018-.1859-.3246-.295-.6977-.295-1.0982Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
