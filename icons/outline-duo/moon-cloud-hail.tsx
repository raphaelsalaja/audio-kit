...
function MoonCloudHail({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.2477 5.65292C14.5584 5.65292 14.8609 5.61752 15.1512 5.55055C14.8049 7.02224 13.6465 8.18068 12.1748 8.52713C11.5168 7.46147 10.3451 6.75 9 6.75C8.6366 6.75 8.28591 6.80197 7.9546 6.89884C7.51019 6.2539 7.25 5.47222 7.25 4.62977C7.25 2.72923 8.5742 1.13799 10.3503 0.728329C10.2807 1.02396 10.2439 1.33224 10.2439 1.64911C10.2439 3.86035 12.0365 5.65292 14.2477 5.65292Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
