...
function MobileWave2({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.25 14.25V11.75V3.75C14.25 2.645 13.355 1.75 12.25 1.75H5.75C4.645 1.75 3.75 2.645 3.75 3.75V12.25V14.25C3.75 15.355 4.645 16.25 5.75 16.25H12.25C13.355 16.25 14.25 15.355 14.25 14.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
