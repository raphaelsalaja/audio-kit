...
function ImageSparkle3({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M10.0199 8.77017L3.97482 14.7603H14.0267C15.2684 14.7603 16.2751 13.7537 16.2751 12.5119L12.4809 8.76764C11.7984 8.09413 10.701 8.09526 10.0199 8.77017Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
