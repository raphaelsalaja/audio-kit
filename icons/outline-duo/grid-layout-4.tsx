...
function GridLayout4({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M11.75 15.25H14.25C14.8023 15.25 15.25 14.8023 15.25 14.25L15.25 3.75C15.25 3.19771 14.8023 2.75 14.25 2.75H11.75C11.1977 2.75 10.75 3.19771 10.75 3.75L10.75 14.25C10.75 14.8023 11.1977 15.25 11.75 15.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
