...
function SquareDotted({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M13.5 2.5H4.5C3.39543 2.5 2.5 3.39543 2.5 4.5V13.5C2.5 14.6046 3.39543 15.5 4.5 15.5H13.5C14.6046 15.5 15.5 14.6046 15.5 13.5V4.5C15.5 3.39543 14.6046 2.5 13.5 2.5Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
