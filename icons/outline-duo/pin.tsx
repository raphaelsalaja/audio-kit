...
function Pin({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M9 1.75C12.3137 1.75 15 4.438 15 7.75C15 12.25 10.5833 15.75 9 16.25C7.4167 15.75 3 12.25 3 7.75C3 4.438 5.6863 1.75 9 1.75ZM9 5.75C7.8954 5.75 7 6.646 7 7.75C7 8.854 7.8954 9.75 9 9.75C10.1046 9.75 11 8.854 11 7.75C11 6.646 10.1046 5.75 9 5.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
