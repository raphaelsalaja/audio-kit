...
function CubeTransparent({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m8.0367,2.2724l-4.0797,2.487c-.5923.3612-.957,1.0261-.957,1.7455v4.9902c0,.7194.3648,1.3843.957,1.7455l4.0797,2.487c.5961.3632,1.3305.3632,1.9266,0l4.0797-2.487c.5922-.3612.957-1.0261.957-1.7455v-4.9902c0-.7194-.3648-1.3843-.957-1.7455l-4.0797-2.487c-.5961-.3632-1.3305-.3632-1.9266,0Z"
          fill={secondaryfill}
          opacity=".3"
          strokeWidth="0"
        />
