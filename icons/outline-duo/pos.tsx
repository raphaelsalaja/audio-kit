...
function Pos({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M12.75 0.75H5.25C4.145 0.75 3.25 1.645 3.25 2.75V12.25C3.25 13.355 4.145 14.25 5.25 14.25H5.75V11.75H12.25V14.25H12.75C13.855 14.25 14.75 13.355 14.75 12.25V2.75C14.75 1.645 13.855 0.75 12.75 0.75Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
