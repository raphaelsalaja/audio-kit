    ...
    >
      ...
      <g fill={fill}>
        <path
          ...
          fill="none"
          stroke="url(#nc-loader-2-outline-duo-gradient-1)"
          strokeWidth="1.5"
        />
        <path
          d="M9 16.25C4.99594 16.25 1.75 13.0041 1.75 9C1.75 4.99594 4.99594 1.75 9 1.75"
          fill="none"
          stroke="url(#nc-loader-2-outline-duo-gradient-2)"
          strokeWidth="1.5"
        />
        ...
        <defs fill="none" stroke="none">
          <linearGradient
            id="nc-loader-2-outline-duo-gradient-1"
            fill="none"
            ...
            y2="16.25"
          >
            <stop fill="none" stopOpacity="0.5" stroke="none" />
            <stop fill="none" offset="1" stroke="none" />
          </linearGradient>
          <linearGradient
            id="nc-loader-2-outline-duo-gradient-2"
            fill="none"
            gradientUnits="userSpaceOnUse"
            stroke="none"
            x1="9"
