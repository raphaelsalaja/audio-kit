...
function Books({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M2 6.75H11.75C12.8546 6.75 13.75 7.6454 13.75 8.75C13.75 9.8546 12.8546 10.75 11.75 10.75H2C2.5327 9.2803 2.594 8.4153 2 6.75Z"
          fill={secondaryfill}
          opacity="0.3"
          stroke="none"
        />
        ...
        />
        <path
          d="M12.5 13H8.5V16.5C8.5 16.702 8.622 16.885 8.809 16.962C8.996 17.041 9.21 16.997 9.354 16.854L10.5 15.708L11.646 16.854C11.742 16.95 11.87 17 12 17C12.064 17 12.13 16.988 12.191 16.962C12.378 16.885 12.5 16.702 12.5 16.5V13Z"
          fill={fill}
          stroke="none"
        />
      </g>
