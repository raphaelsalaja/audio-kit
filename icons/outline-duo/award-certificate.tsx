...
function AwardCertificate({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.75 7.2565C14.667 7.2522 14.584 7.25 14.5 7.25C11.877 7.25 9.75 9.3766 9.75 12C9.75 13.2382 10.224 14.3658 11 15.2113V16.25H4.25C3.145 16.25 2.25 15.355 2.25 14.25V3.75C2.25 2.645 3.145 1.75 4.25 1.75H12.75C13.855 1.75 14.75 2.645 14.75 3.75V7.2565Z"
          fill={secondaryfill}
          fillRule="evenodd"
          opacity="0.3"
          stroke="none"
