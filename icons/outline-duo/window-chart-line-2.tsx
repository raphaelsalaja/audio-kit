  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M8.75 17.25L10.5 15.25L11.5 16.5L13.5 13L15 15.5L17.25 11"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M16.25 7.75V4.75C16.25 3.65 15.355 2.75 14.25 2.75H3.75C2.645 2.75 1.75 3.65 1.75 4.75V13.25C1.75 14.35 2.645 15.25 3.75 15.25H6.5135"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
