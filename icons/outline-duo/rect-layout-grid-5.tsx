...
function RectLayoutGrid5({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M11.75 9H16.25V13.25C16.25 14.3546 15.3546 15.25 14.25 15.25H11.75V9Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
        <path
          d="M1.75 4.75C1.75 3.64543 2.64543 2.75 3.75 2.75H6.25V15.25H3.75C2.64543 15.25 1.75 14.3546 1.75 13.25V4.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
