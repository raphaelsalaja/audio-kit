  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M6.4526 2.2103C7.245 1.9128 8.1035 1.75 9 1.75C13.004 1.75 16.25 4.996 16.25 9C16.25 13.004 13.004 16.25 9 16.25C4.996 16.25 1.75 13.004 1.75 9C1.75 8.1036 1.9128 7.24501 2.2103 6.45261"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
        ...
        />
        <path
          d="M8.29305 8.293L3.88306 3.883"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
