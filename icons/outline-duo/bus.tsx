...
function Bus({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M12.75 14.75V13.75H5.25V14.75C5.25 15.3023 4.8023 15.75 4.25 15.75H3.25C2.6977 15.75 2.25 15.3023 2.25 14.75V8.28687H15.75V14.75C15.75 15.3023 15.3023 15.75 14.75 15.75H13.75C13.1977 15.75 12.75 15.3023 12.75 14.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
