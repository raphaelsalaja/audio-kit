...
function BoxingGlove({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M6.75647 2.25C5.09962 2.25 3.75647 3.59315 3.75647 5.25V6.82907C2.89058 7.04884 2.25 7.83347 2.25 8.76772L2.25 10.0764C2.25 11.8713 3.70507 13.3264 5.5 13.3264H12.5C14.0188 13.3264 15.25 12.0952 15.25 10.5764V9.41338V6.76772V5.25C15.25 3.59315 13.9069 2.25 12.25 2.25H6.75647Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
        ...
        />
        <path
          d="M12.25 5.75C12.25 6.855 11.355 7.75 10.25 7.75H7.57999"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
