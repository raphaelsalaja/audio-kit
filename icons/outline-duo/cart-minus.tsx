...
function CartMinus({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M9.6416 4.5293C9.95886 5.38734 10.7817 6 11.75 6H15.0381C15.0319 6.02363 15.0266 6.04769 15.0186 6.07129L13.6592 10.0723C13.5215 10.4776 13.141 10.7508 12.7129 10.751H5.00098L4.09277 4.25391L9.6416 4.5293Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
