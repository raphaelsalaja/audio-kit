...
function Compose3({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M16.25 1.75C10.6925 2.12678 7.92157 6.53826 7.2308 8.69691C7.7742 9.1029 9.42485 9.81293 11.6803 9.40517C13.9357 8.9974 14.4984 7.30727 14.4978 6.51318C16.2065 5.46249 15.3786 3.8387 16.25 1.75Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          stroke="none"
        />
