...
function RainbowCloud({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M4 10.25C4 7.62665 6.12665 5.5 8.75 5.5C11.3734 5.5 13.1032 7.03207 12.2047 7.41551C11.4287 7.74671 10.6529 8.18979 10.125 8.82812C9.75938 8.42951 9.33352 8.25 8.75 8.25C7.64543 8.25 6.75 9.14543 6.75 10.25V11.5H4V10.25Z"
          fill={secondaryfill}
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
