...
function ImageUpscale({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m4.75,2c-1.5166,0-2.75,1.2334-2.75,2.75,0,.4141.3359.75.75.75s.75-.3359.75-.75c0-.6895.5605-1.25,1.25-1.25.4141,0,.75-.3359.75-.75s-.3359-.75-.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
          d="m15.25,12.5c-.4141,0-.75.3359-.75.75,0,.6895-.5605,1.25-1.25,1.25-.4141,0-.75.3359-.75.75s.3359.75.75.75c1.5166,0,2.75-1.2334,2.75-2.75,0-.4141-.3359-.75-.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
          d="m8.75,2h-1c-.4141,0-.75.3359-.75.75s.3359.75.75.75h1c.4141,0,.75-.3359.75-.75s-.3359-.75-.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
          d="m15.25,8.5c-.4141,0-.75.3359-.75.75v1c0,.4141.3359.75.75.75s.75-.3359.75-.75v-1c0-.4141-.3359-.75-.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
