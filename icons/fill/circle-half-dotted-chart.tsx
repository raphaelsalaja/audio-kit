...
function CircleHalfDottedChart({
  fill = "currentColor",
  secondaryfill,
  strokewidth = 1,
  width = "1em",
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="m9,13c.4141,0,.75-.3359.75-.75v-4.25c0-.4141-.3359-.75-.75-.75s-.75.3359-.75.75v4.25c0,.4141.3359.75.75.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
          d="m6.5,12.25v-2c0-.4141-.3359-.75-.75-.75s-.75.3359-.75.75v2c0,.4141.3359.75.75.75s.75-.3359.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
          d="m13,12.25v-6.5c0-.4141-.3359-.75-.75-.75s-.75.3359-.75.75v6.5c0,.4141.3359.75.75.75s.75-.3359.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
...
export default CircleHalfDottedChart;
