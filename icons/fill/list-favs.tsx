  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="m15.75,6h-6c-.4141,0-.75-.3359-.75-.75s.3359-.75.75-.75h6c.4141,0,.75.3359.75.75s-.3359.75-.75.75Z"
          fill={fill}
          strokeWidth="0"
        />
        <path
          d="m15.75,13.5h-6c-.4141,0-.75-.3359-.75-.75s.3359-.75.75-.75h6c.4141,0,.75.3359.75.75s-.3359.75-.75.75Z"
          fill={fill}
          strokeWidth="0"
        />
      </g>
