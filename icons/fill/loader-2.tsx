    ...
    >
      ...
      <g fill={fill}>
        <path
          ...
          fill="url(#nc-loader-2-fill-gradient-1)"
        />
        <path
          ...
          fill="url(#nc-loader-2-fill-gradient-2)"
        />
        <circle cx="9" cy="16.25" fill={secondaryfill} r="0.75" />
        <defs fill="none">
          <linearGradient
            id="nc-loader-2-fill-gradient-1"
            fill="none"
          ...
          >
            ...
            <stop fill="none" offset="1" stopColor={fill} />
          </linearGradient>
          <linearGradient
            id="nc-loader-2-fill-gradient-2"
            fill="none"
            gradientUnits="userSpaceOnUse"
            x1="9"
            x2="9"
