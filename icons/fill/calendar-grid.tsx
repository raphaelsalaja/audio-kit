...
function CalendarGrid({
  ...
  return (
    ...
    >
      <title>{title}</title>
      <g fill={fill}>
        <rect height="1.5" width="13.5" fill={secondaryfill} x="2.25" y="10" />
        <rect height="9" width="1.5" fill={secondaryfill} x="6" y="6.25" />
        <rect height="9" width="1.5" fill={secondaryfill} x="10.5" y="6.25" />
        <path
