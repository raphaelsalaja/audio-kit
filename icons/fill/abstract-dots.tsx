  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        <circle cx="9" cy="2" fill={secondaryfill} r="1" strokeWidth="0" />
        <circle cx="2" cy="9" fill={secondaryfill} r="1" strokeWidth="0" />
        <circle cx="9" cy="16" fill={secondaryfill} r="1" strokeWidth="0" />
        <circle cx="16" cy="9" fill={secondaryfill} r="1" strokeWidth="0" />
      </g>
    </svg>
  );
}
