  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M2.75 2C2.46853 2 2.21075 2.15761 2.08245 2.40814C1.95414 2.65868 1.97693 2.95996 2.14144 3.18835L7 9.9334V16.0325C7 16.2894 7.13144 16.5284 7.34835 16.6659C7.56526 16.8035 7.83747 16.8205 8.0698 16.7109L10.5737 15.6387C10.8363 15.5149 11.0039 15.2507 11.0039 14.9603V13.9867C9.87702 13.8641 9 12.9095 9 11.75C9 10.5074 10.0074 9.5 11.25 9.5H11.3157L11.5 9.24394C11.5026 8.25553 12.1425 7.41696 13.0305 7.11748L15.8587 3.18813C16.0231 2.95972 16.0458 2.65849 15.9175 2.40802C15.7892 2.15755 15.5314 2 15.25 2H2.75Z"
          fill={fill}
        />
      </g>
    </svg>
