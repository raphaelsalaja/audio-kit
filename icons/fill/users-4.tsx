  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M10.7257 14.8253C11.3315 14.931 12.0101 15.0005 12.75 15.0005C14.1259 15.0005 15.2899 14.7591 16.1658 14.4945C16.9809 14.2483 17.5938 13.4114 17.3906 12.4813C16.924 10.3473 15.0249 8.74951 12.75 8.74951C11.7681 8.74951 10.8563 9.04714 10.0994 9.55704C10.7054 10.302 11.1434 11.1893 11.3558 12.1608C11.5804 13.1888 11.288 14.1272 10.7257 14.8253Z"
          fill={secondaryfill}
        />
        <path
