  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M12.75 10.25C12.25 7.312 12.321 4.673 12.321 4.673C12.281 4.152 11.846 3.75 11.324 3.75H6.67599C6.15299 3.75 5.719 4.152 5.679 4.673C5.679 4.673 5.75 7.312 5.25 10.25"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
