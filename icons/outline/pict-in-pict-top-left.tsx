  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M6.25 8.25H4.75C3.645 8.25 2.75 7.355 2.75 6.25V4.75C2.75 3.645 3.645 2.75 4.75 2.75H6.25C7.355 2.75 8.25 3.645 8.25 4.75V6.25C8.25 7.355 7.355 8.25 6.25 8.25Z"
          fill="none"
