...
function EnvelopeOpenCheck({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M1.75 6.75C1.75 6.022 2.146 5.38901 2.784 5.03701L8.517 1.874C8.818 1.708 9.182 1.708 9.483 1.874L15.216 5.03701C15.854 5.38901 16.25 6.021 16.25 6.75"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
