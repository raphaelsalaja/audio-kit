  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M15.75 10.7505H12.25C11.9739 10.7505 11.75 10.9744 11.75 11.2505V13.2505C11.75 13.5266 11.9739 13.7505 12.25 13.7505H15.75C16.0261 13.7505 16.25 13.5266 16.25 13.2505V11.2505C16.25 10.9744 16.0261 10.7505 15.75 10.7505Z"
          fill="none"
          stroke={secondaryfill}
          strokeLinecap="round"
          strokeLinejoin="round"
