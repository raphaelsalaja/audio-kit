...
function MsgClock({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M16.1913 8.14661C15.7691 4.54541 12.7151 1.75 9 1.75C4.996 1.75 1.75 4.996 1.75 9C1.75 10.319 2.10799 11.552 2.72299 12.617C3.15299 13.423 2.67 15.329 1.75 16.25C3 16.318 4.647 15.753 5.383 15.277C5.872 15.559 6.64699 15.933 7.66199 16.125C7.82189 16.1553 7.9843 16.1786 8.1485 16.1963"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
