...
function FolderLock({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M2.25 8.75V4.75C2.25 3.645 3.145 2.75 4.25 2.75H6.201C6.808 2.75 7.381 3.02499 7.761 3.49799L8.364 4.25H13.75C14.855 4.25 15.75 5.145 15.75 6.25V8.53699"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
