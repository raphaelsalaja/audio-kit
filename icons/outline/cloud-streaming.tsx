...
function CloudStreaming({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M10.704 6.042L8.396 4.696C7.999 4.464 7.5 4.751 7.5 5.211V7.904C7.5 8.364 7.999 8.651 8.396 8.419L10.704 7.073C11.098 6.843 11.098 6.272 10.704 6.042Z"
          fill={secondaryfill}
          stroke="none"
        />
        <path
