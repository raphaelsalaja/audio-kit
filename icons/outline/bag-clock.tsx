  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M14.7655 7.8018L14.659 6.5769C14.569 5.5439 13.704 4.75 12.667 4.75H5.33397C4.29697 4.75 3.43096 5.543 3.34196 6.5769L2.68997 14.0769C2.58797 15.2451 3.50997 16.25 4.68197 16.25H8.17567"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
