  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M9.7664 2.7505H4.75C3.645 2.7505 2.75 3.6465 2.75 4.7505V13.2505C2.75 14.3545 3.645 15.2505 4.75 15.2505H13.25C14.355 15.2505 15.25 14.3545 15.25 13.2505V8.1878"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
