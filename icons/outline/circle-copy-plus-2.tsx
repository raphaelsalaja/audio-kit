  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M7.25 12.75C10.288 12.75 12.75 10.288 12.75 7.25C12.75 4.212 10.288 1.75 7.25 1.75C4.212 1.75 1.75 4.212 1.75 7.25C1.75 10.288 4.212 12.75 7.25 12.75Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
