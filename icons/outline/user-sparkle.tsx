  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M10.8242 10.0405C10.2466 9.8593 9.63769 9.7505 8.99999 9.7505C6.44899 9.7505 4.26099 11.2805 3.29099 13.4705C2.92599 14.2955 3.37799 15.2444 4.23799 15.5154C5.46299 15.9014 7.08389 16.2495 8.99999 16.2495C9.03409 16.2495 9.06449 16.2456 9.09819 16.2451"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
