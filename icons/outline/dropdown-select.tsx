...
function DropdownSelect({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M14.583 7.5H12.083C11.925 7.5 11.7811 7.58901 11.7101 7.73001C11.6401 7.87101 11.655 8.03999 11.749 8.16599L12.999 9.83301C13.078 9.93801 13.201 10 13.332 10C13.463 10 13.587 9.93801 13.665 9.83301L14.915 8.16599C15.01 8.03999 15.025 7.87101 14.954 7.73001C14.883 7.58901 14.739 7.5 14.581 7.5H14.583Z"
          fill={fill}
          stroke="none"
        />
        <path
