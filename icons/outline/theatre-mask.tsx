...
function TheatreMask({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="m4.5,7.5c-.1602,0-.3154-.0776-.4111-.2153-.1289-.1865-.1162-.4375.0312-.6099.4414-.5146.9092-.7749,1.3936-.7749h.0186c.4824.0063.9385.2705,1.3564.7852.1445.1787.1484.4341.0098.6172-.1396.1851-.3867.249-.5977.1562-.498-.2163-1.0166-.2124-1.6289.0112-.0566.0205-.1143.0303-.1719.0303Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
        <path
