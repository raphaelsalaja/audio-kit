  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M10.75 16.25C13.788 16.25 16.25 13.788 16.25 10.75C16.25 7.712 13.788 5.25 10.75 5.25C7.712 5.25 5.25 7.712 5.25 10.75C5.25 13.788 7.712 16.25 10.75 16.25Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
