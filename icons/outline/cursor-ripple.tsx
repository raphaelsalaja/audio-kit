  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M8.34504 8.02801L15.659 10.538C15.881 10.614 15.885 10.926 15.666 11.008L12.387 12.241C12.32 12.266 12.266 12.32 12.241 12.387L11.008 15.666C10.925 15.885 10.614 15.881 10.538 15.659L8.02805 8.345C7.96005 8.148 8.14904 7.96001 8.34604 8.02701L8.34504 8.02801Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
