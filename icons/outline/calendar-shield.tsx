  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M15.7412 8.019L15.75 8.0229V4.75C15.75 3.646 14.855 2.75 13.75 2.75H4.25C3.145 2.75 2.25 3.646 2.25 4.75V13.25C2.25 14.354 3.145 15.25 4.25 15.25H8.7676"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
