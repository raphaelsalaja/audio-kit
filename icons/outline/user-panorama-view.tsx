  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M5.9467 15.801C5.48 15.6608 5.166 15.1995 5.27 14.726C5.6451 13.0239 7.1722 11.75 9 11.75C10.8278 11.75 12.3549 13.0239 12.73 14.726C12.834 15.1986 12.521 15.6609 12.0533 15.801C11.2697 16.0359 10.2293 16.25 9 16.25C7.7707 16.25 6.7303 16.0369 5.9467 15.801Z"
          fill="none"
          stroke={secondaryfill}
          strokeLinecap="round"
          strokeLinejoin="round"
