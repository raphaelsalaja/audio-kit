  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M14.75 1.75H8.75C8.198 1.75 7.75 2.198 7.75 2.75V15.25C7.75 15.802 8.198 16.25 8.75 16.25H14.75C15.302 16.25 15.75 15.802 15.75 15.25V2.75C15.75 2.198 15.302 1.75 14.75 1.75Z"
          fill="none"
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
