...
function Closet({
  ...
  return (
    ...
    >
      ...
      <g fill="none">
        <path
          d="M10.5 3.5L2.82918 7.33541C2.321 7.5895 2 8.10889 2 8.67705V20.132C2 20.8753 2.78231 21.3588 3.44721 21.0264L10.1495 17.6753"
          stroke={fill}
        />
        <path
          d="M18 10L10 14V4L18 8V10Z"
          fill={secondaryfill}
          fillOpacity=".3"
        />
        <path d="M14 17.5V16V16.5" stroke={fill} strokeLinecap="round" />
        <path d="M18 10L10 14L18 18" stroke={fill} strokeLinejoin="round" />
        <path
