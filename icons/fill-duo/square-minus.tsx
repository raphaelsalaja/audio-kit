  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M12.2501 8.25H5.75009C5.33599 8.25 5.00009 8.5859 5.00009 9C5.00009 9.4141 5.33599 9.75 5.75009 9.75H12.2501C12.6642 9.75 13.0001 9.4141 13.0001 9C13.0001 8.5859 12.6642 8.25 12.2501 8.25Z"
          fill={fill}
        />
      </g>
    </svg>
