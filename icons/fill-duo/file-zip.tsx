  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M7 10.5C7.828 10.5 8.5 11.14 8.5 11.9286V14H5.5L5.5 11.9286C5.5 11.14 6.172 10.5 7 10.5Z"
          fill={fill}
        />
        <path d="M7 9H9V7H7V9Z" fill={fill} />
        <path d="M5 7H7V5H5V7Z" fill={fill} />
        <path d="M7 5H9V3H7V5Z" fill={fill} />
        <path d="M5 3H7V1H5V3Z" fill={fill} />
      </g>
    </svg>
  );
}
