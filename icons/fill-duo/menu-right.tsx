  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M15.7501 15H9.75009C9.33599 15 9.00009 14.6641 9.00009 14.25C9.00009 13.8359 9.33599 13.5 9.75009 13.5H15.7501C16.1642 13.5 16.5001 13.8359 16.5001 14.25C16.5001 14.6641 16.1642 15 15.7501 15Z"
          fill={fill}
        />
      </g>
    </svg>
