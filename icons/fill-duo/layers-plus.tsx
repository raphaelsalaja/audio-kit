  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M17.2501 2.5H15.5001V0.75C15.5001 0.3359 15.1642 0 14.7501 0C14.336 0 14.0001 0.3359 14.0001 0.75V2.5H12.2501C11.836 2.5 11.5001 2.8359 11.5001 3.25C11.5001 3.6641 11.836 4 12.2501 4H14.0001V5.75C14.0001 6.1641 14.336 6.5 14.7501 6.5C15.1642 6.5 15.5001 6.1641 15.5001 5.75V4H17.2501C17.6642 4 18.0001 3.6641 18.0001 3.25C18.0001 2.8359 17.6642 2.5 17.2501 2.5Z"
          fill={fill}
        />
        <path
