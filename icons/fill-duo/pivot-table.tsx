...
function PivotTable({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M6.5 6.5H15.25C15.6642 6.5 16 6.1642 16 5.75V4.75C16 3.2312 14.7688 2 13.25 2H6.5V6.5Z"
          fill={secondaryfill}
          opacity="0.4"
        />
        <path
        ...
        <path
          ...
          fill={fill}
        />
        <path d="M6.5 6.5V2H4.75C3.233 2 2 3.233 2 4.75V6.5H6.5Z" fill={fill} />
      </g>
    </svg>
  );
}
