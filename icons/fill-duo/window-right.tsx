  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M14.2501 4.5H11.7501C11.3359 4.5 11.0001 4.83579 11.0001 5.25V12.75C11.0001 13.1642 11.3359 13.5 11.7501 13.5H14.2501C14.6643 13.5 15.0001 13.1642 15.0001 12.75V5.25C15.0001 4.83579 14.6643 4.5 14.2501 4.5Z"
          fill={fill}
        />
      </g>
    </svg>
