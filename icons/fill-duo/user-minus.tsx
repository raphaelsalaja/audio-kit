  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M8.99999 9C6.14167 9 3.69058 10.7157 2.60517 13.1674C2.05162 14.4186 2.74425 15.8317 4.01259 16.2313C5.29503 16.6354 6.99283 17 8.99999 17C9.85328 17 10.6507 16.9341 11.384 16.8273C10.5712 16.4881 10 15.6858 10 14.75C10 13.5074 11.0074 12.5 12.25 12.5H15.0554C13.8476 10.41 11.5911 9 8.99999 9Z"
          fill={secondaryfill}
          fillOpacity="0.4"
        />
        <path
