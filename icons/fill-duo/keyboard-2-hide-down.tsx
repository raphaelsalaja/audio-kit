...
function Keyboard2HideDown({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M1 3.75C1 2.23128 2.23069 1 3.75 1H14.25C15.7693 1 17 2.23128 17 3.75V10.25C17 11.7687 15.7693 13 14.25 13H3.75C2.23069 13 1 11.7687 1 10.25V3.75Z"
          fill={secondaryfill}
          fillOpacity="0.4"
          fillRule="evenodd"
        />
        ...
        />
        <path
          d="M6.25 3.5H5.75C5.474 3.5 5.25 3.7239 5.25 4V4.5C5.25 4.7761 5.474 5 5.75 5H6.25C6.526 5 6.75 4.7761 6.75 4.5V4C6.75 3.7239 6.526 3.5 6.25 3.5Z"
          fill={fill}
        />
        <path
          d="M9.25 3.5H8.75C8.474 3.5 8.25 3.7239 8.25 4V4.5C8.25 4.7761 8.474 5 8.75 5H9.25C9.526 5 9.75 4.7761 9.75 4.5V4C9.75 3.7239 9.526 3.5 9.25 3.5Z"
          fill={fill}
        />
        <path
          d="M12.25 3.5H11.75C11.474 3.5 11.25 3.7239 11.25 4V4.5C11.25 4.7761 11.474 5 11.75 5H12.25C12.526 5 12.75 4.7761 12.75 4.5V4C12.75 3.7239 12.526 3.5 12.25 3.5Z"
          fill={fill}
        />
        <path
