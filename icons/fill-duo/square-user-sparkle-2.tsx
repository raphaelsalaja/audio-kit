...
function SquareUserSparkle2({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M10.7307 2.0005H4.75C3.23079 2.0005 2 3.23129 2 4.7505V13.2505C2 14.7697 3.23079 16.0005 4.75 16.0005H13.25C14.7692 16.0005 16 14.7697 16 13.2505V7.20419C15.7002 7.36669 15.3585 7.4575 15 7.4575C14.1055 7.4575 13.2907 6.86979 13.007 6.02184L12.739 5.21783L11.9391 4.95068C11.0892 4.6689 10.5 3.8531 10.5 2.9575C10.5 2.61757 10.582 2.29087 10.7307 2.0005Z"
          fill={secondaryfill}
          fillOpacity="0.4"
        />
        <path
