...
function InputPasswordCheck({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M8.5 13C8.5 9.9673 10.9673 7.5 14 7.5C15.1068 7.5 16.1363 7.83148 17 8.39618V6.75C17 5.2339 15.767 4 14.25 4H3.75C2.233 4 1 5.2339 1 6.75V11.25C1 12.7671 2.233 14 3.75 14H8.5956C8.5356 13.6753 8.5 13.3418 8.5 13Z"
          fill={secondaryfill}
          opacity="0.4"
        />
        <path
