  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M9 13.25C9 12.2838 9.78379 11.5 10.75 11.5H14.25C15.2162 11.5 16 12.2838 16 13.25V14.25C16 15.2162 15.2162 16 14.25 16H10.75C9.78379 16 9 15.2162 9 14.25V13.25Z"
          fill={secondaryfill}
          fillOpacity="0.4"
          fillRule="evenodd"
        />
