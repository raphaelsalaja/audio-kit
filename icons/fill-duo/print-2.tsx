  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M7 14.25C7 13.8358 7.33579 13.5 7.75 13.5H10.25C10.6642 13.5 11 13.8358 11 14.25C11 14.6642 10.6642 15 10.25 15H7.75C7.33579 15 7 14.6642 7 14.25Z"
          fill={fill}
          fillRule="evenodd"
        />
        <path
          d="M7 11.75C7 11.3358 7.33579 11 7.75 11H10.25C10.6642 11 11 11.3358 11 11.75C11 12.1642 10.6642 12.5 10.25 12.5H7.75C7.33579 12.5 7 12.1642 7 11.75Z"
          fill={fill}
          fillRule="evenodd"
        />
      </g>
