...
function UsersBookmark({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M11 11.7505C11 10.7843 11.7838 10.0005 12.75 10.0005H15.25C16.2162 10.0005 17 10.7843 17 11.7505V17.2505C17 17.5539 16.8173 17.8273 16.537 17.9434C16.2568 18.0595 15.9342 17.9953 15.7197 17.7808L14 16.0612L12.2803 17.7808C12.0658 17.9953 11.7432 18.0595 11.463 17.9434C11.1827 17.8273 11 17.5539 11 17.2505V11.7505Z"
          fill={fill}
          fillRule="evenodd"
        />
        <path
