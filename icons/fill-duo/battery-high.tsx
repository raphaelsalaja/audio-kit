  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M7.75 6.5C8.16421 6.5 8.5 6.83579 8.5 7.25V10.75C8.5 11.1642 8.16421 11.5 7.75 11.5C7.33579 11.5 7 11.1642 7 10.75V7.25C7 6.83579 7.33579 6.5 7.75 6.5Z"
          fill={fill}
          fillRule="evenodd"
        />
        <path
          d="M10.75 6.5C11.1642 6.5 11.5 6.83579 11.5 7.25V10.75C11.5 11.1642 11.1642 11.5 10.75 11.5C10.3358 11.5 10 11.1642 10 10.75V7.25C10 6.83579 10.3358 6.5 10.75 6.5Z"
          fill={fill}
          fillRule="evenodd"
        />
      </g>
