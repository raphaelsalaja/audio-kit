  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M15.2501 9.75H2.75009C2.33599 9.75 2.00009 9.4141 2.00009 9C2.00009 8.5859 2.33599 8.25 2.75009 8.25H15.2501C15.6642 8.25 16.0001 8.5859 16.0001 9C16.0001 9.4141 15.6642 9.75 15.2501 9.75Z"
          fill={secondaryfill}
          opacity="0.4"
        />
      </g>
