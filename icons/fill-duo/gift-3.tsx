  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M7 7V11.499C7 11.701 7.12201 11.884 7.30901 11.961C7.49601 12.04 7.71 11.996 7.854 11.853L9 10.707L10.146 11.853C10.242 11.949 10.37 11.999 10.5 11.999C10.564 11.999 10.63 11.987 10.691 11.961C10.878 11.884 11 11.701 11 11.499V7H7Z"
          fill={fill}
        />
        <path
