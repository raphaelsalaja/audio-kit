  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M12.2501 15H5.75009C5.33599 15 5.00009 14.6641 5.00009 14.25C5.00009 13.8359 5.33599 13.5 5.75009 13.5H12.2501C12.6642 13.5 13.0001 13.8359 13.0001 14.25C13.0001 14.6641 12.6642 15 12.2501 15Z"
          fill={secondaryfill}
          opacity="0.4"
        />
        <path
          d="M12.2501 8H5.75009C5.33599 8 5.00009 7.6641 5.00009 7.25C5.00009 6.8359 5.33599 6.5 5.75009 6.5H12.2501C12.6642 6.5 13.0001 6.8359 13.0001 7.25C13.0001 7.6641 12.6642 8 12.2501 8Z"
          fill={secondaryfill}
          opacity="0.4"
        />
        <path
