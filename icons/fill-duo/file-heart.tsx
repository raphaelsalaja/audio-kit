...
function FileHeart({
  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        <path
          d="M13.731 17.192C13.901 17.281 14.099 17.281 14.269 17.192C15.166 16.72 18 15.011 18 12.231C18.004 11.01 17.026 10.016 15.813 10.009C15.083 10.018 14.405 10.389 14 11C13.595 10.389 12.916 10.019 12.187 10.009C10.974 10.016 9.99601 11.011 10 12.231C10 15.011 12.834 16.72 13.731 17.192Z"
          fill={fill}
        />
        <path
        ...
        />
        <path
          d="M10.3491 9.00649C9.74294 9.35863 9.24713 9.87785 8.92203 10.5H5.75C5.33579 10.5 5 10.1642 5 9.75C5 9.33579 5.33579 9 5.75 9H10.25C10.2836 9 10.3167 9.00221 10.3491 9.00649Z"
          fill={fill}
        />
      </g>
    </svg>
