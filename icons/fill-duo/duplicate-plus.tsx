  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M10.5 13.5C10.0859 13.5 9.75 13.1641 9.75 12.75V8.25C9.75 7.8359 10.0859 7.5 10.5 7.5C10.9141 7.5 11.25 7.8359 11.25 8.25V12.75C11.25 13.1641 10.9141 13.5 10.5 13.5Z"
          fill={fill}
        />
        <path
          d="M12.75 11.25H8.25C7.8359 11.25 7.5 10.9141 7.5 10.5C7.5 10.0859 7.8359 9.75 8.25 9.75H12.75C13.1641 9.75 13.5 10.0859 13.5 10.5C13.5 10.9141 13.1641 11.25 12.75 11.25Z"
          fill={fill}
        />
      </g>
    </svg>
