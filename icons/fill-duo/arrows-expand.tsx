  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M7.75 2.75C7.75 2.3359 7.4141 2 7 2H2.75C2.3359 2 2 2.3359 2 2.75V7C2 7.4141 2.3359 7.75 2.75 7.75C3.1641 7.75 3.5 7.4141 3.5 7V4.56049L6.4697 7.53021C6.6162 7.67671 6.8076 7.74991 7 7.74991C7.1924 7.74991 7.3838 7.67671 7.5303 7.53021C7.8233 7.23721 7.8233 6.7626 7.5303 6.4697L4.56059 3.5H7.00011C7.41421 3.5 7.75 3.1641 7.75 2.75Z"
          fill={fill}
        />
        <path
          d="M15.25 10.25C14.8359 10.25 14.5 10.5859 14.5 11V13.4395L11.5303 10.4698C11.2373 10.1768 10.7627 10.1768 10.4698 10.4698C10.1769 10.7628 10.1768 11.2374 10.4698 11.5303L13.4395 14.5H11C10.5859 14.5 10.25 14.8359 10.25 15.25C10.25 15.6641 10.5859 16 11 16H15.25C15.6641 16 16 15.6641 16 15.25V11C16 10.5859 15.6641 10.25 15.25 10.25Z"
          fill={fill}
        />
      </g>
    </svg>
