  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M12.25 2.5C12.664 2.5 13 2.1642 13 1.75C13 1.3358 12.664 1 12.25 1C11.836 1 11.5 1.3358 11.5 1.75C11.5 2.1642 11.836 2.5 12.25 2.5Z"
          fill={fill}
        />
        <path
          d="M14.75 5C15.164 5 15.5 4.6642 15.5 4.25C15.5 3.8358 15.164 3.5 14.75 3.5C14.336 3.5 14 3.8358 14 4.25C14 4.6642 14.336 5 14.75 5Z"
          fill={fill}
        />
        <path
          d="M11.25 12.5C11.664 12.5 12 12.1642 12 11.75C12 11.3358 11.664 11 11.25 11C10.836 11 10.5 11.3358 10.5 11.75C10.5 12.1642 10.836 12.5 11.25 12.5Z"
          fill={fill}
        />
        <path
        ...
        />
        <path
          d="M7.25 12.5C7.94 12.5 8.5 11.9404 8.5 11.25C8.5 10.5596 7.94 10 7.25 10C6.56 10 6 10.5596 6 11.25C6 11.9404 6.56 12.5 7.25 12.5Z"
          fill={fill}
        />
      </g>
    </svg>
