  ...
  return (
    ...
    >
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M3.5 6.75C3.5 6.33579 3.83579 6 4.25 6H13.25C13.6642 6 14 6.33579 14 6.75V11.25C14 11.6642 13.6642 12 13.25 12H4.25C3.83579 12 3.5 11.6642 3.5 11.25V6.75Z"
          fill={fill}
          fillRule="evenodd"
        />
        <path
